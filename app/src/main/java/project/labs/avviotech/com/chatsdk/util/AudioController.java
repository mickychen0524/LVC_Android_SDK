package project.labs.avviotech.com.chatsdk.util;
...
//                AudioController.AudioDevice.SPEAKER_PHONE)) {
...
//
//    /** Construction */
//    public static AudioController create(Context context,
//                                            Runnable deviceStateChangeListener) {
//        return new AudioController(context, deviceStateChangeListener);
//    }
//
...
//        useSpeakerphone = sharedPreferences.getString(context.getString(org.appspot.apprtc.R.string.pref_speakerphone_key),
//                context.getString(org.appspot.apprtc.R.string.pref_speakerphone_default));
//
