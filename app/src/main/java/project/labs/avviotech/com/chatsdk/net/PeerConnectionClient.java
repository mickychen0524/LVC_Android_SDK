package project.labs.avviotech.com.chatsdk.net;
...
public class PeerConnectionClient {
    ...
    private static final PeerConnectionClient serverInstance = new PeerConnectionClient();
    ...
    public static PeerConnectionClient getInstance(boolean isServer) {
        if(isServer) {
            serverInstance.isServer = true;
    ...
    public void createPeerConnectionFactory(
        ...
        if(localRender != null) this.localRenderer = new VideoRenderer(localRender);
        if(remoteRender != null) this.remoteRenderer = new VideoRenderer(remoteRender);
...
//        PeerConnectionFactory.shutdownInternalTracer();
    ...
    private VideoTrack createVideoTrack(VideoCapturer capturer) {
        ...
        localVideoTrack.setEnabled(renderVideo);
        localVideoTrack.addRenderer(instance.localRenderer);
    ...
    private void changeCaptureFormatInternal(int width, int height, int framerate) {
        ...
        if(!isServer) videoCapturer.onOutputFormatRequest(width, height, framerate);
    }
